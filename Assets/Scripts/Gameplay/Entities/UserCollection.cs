...
public class UserCollection
{
    ...
    {
        Characters = JsonHelper.DeserializeObject<List<NFTsCharacter>>(jsonList);
    }

    public void SetSpellsCards(string jsonList)
    {
        Cards.AddRange(JsonHelper.DeserializeObject<List<NFTsSpell>>(jsonList));
    }

    public void SetUnitCards(string jsonList)
    {
        Cards.AddRange(JsonHelper.DeserializeObject<List<NFTsUnit>>(jsonList));
    }
