namespace Cosmicrafts
{
    ...
    public class Spell_01 : Spell
    {
        ...
        [Tooltip("Width of the damage area")]
        [Range(1f, 20f)]
        public float beamWidth = 8f;
        [Tooltip("Width of the visual laser beam")]
        [Range(0.1f, 5f)]
        ...
        private void SetupLineRenderer()
        {
            if (laserLineRenderer == null)
            {
                ...
                laserLineRenderer.startWidth = visualBeamWidth;
                laserLineRenderer.endWidth = visualBeamWidth;
            }
            ...
            // Create start VFX if not provided
            ...
            {
                // Instantiate the start VFX prefab
                GameObject startVfx = Instantiate(laserStartVFX, transform);
                startVfx.name = "LaserStartVFX";
                laserStartVFX = startVfx;
            }
            
            // Create end VFX if not provided
            if (laserEndVFX == null)
            {
            ...
            {
                // Instantiate the end VFX prefab
                GameObject endVfx = Instantiate(laserEndVFX, transform);
                endVfx.name = "LaserEndVFX";
                laserEndVFX = endVfx;
            }
        }
        ...
        private void UpdateLaserBeam()
        {
            ...
            if (laserStartVFX != null)
            {
                ...
                laserStartVFX.transform.localScale = Vector3.one * visualBeamWidth;
            ...
            if (laserEndVFX != null)
            {
                ...
                laserEndVFX.transform.localScale = Vector3.one * visualBeamWidth;
