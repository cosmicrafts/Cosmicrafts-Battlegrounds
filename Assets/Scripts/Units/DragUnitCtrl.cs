...
public class DragUnitCtrl : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        areas = 0;
        // SetStatusColor is commented out since Outlinable is no longer available
    ...
    {
        // Outline functionality removed - can be reimplemented with a different solution if needed
